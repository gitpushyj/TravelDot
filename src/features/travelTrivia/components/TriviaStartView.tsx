...
import { TriviaTopThreeList } from "./TriviaTopThreeList";

// 시즌(주간) 리더보드 대기 화면. 카드 안에 내 최고 + 점선 + 이번 주 1·2·3위.
export function TriviaStartView({
  bestScore,
  loading,
  signedIn,
  topThree,
  ...
  return (
    <View style={{ flex: 1, alignItems: "center", justifyContent: "center", gap: 24, padding: 24 }}>
      ...
      >
        <MyBest bestScore={bestScore} loading={loading} signedIn={signedIn} />
        ...
        <View style={{ gap: 6 }}>
          ...
          {topLoading ? (
            ...
            <TriviaTopThreeList entries={topThree} currentUserId={currentUserId} />
          )}
        </View>
      </View>
